...
const Header = () => {
  return (
    <header className="fixed bottom-5 w-full md:top-5 md:bottom-auto md:left-1/2 md:-translate-x-1/2 md:w-auto z-50 transition duration-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex justify-center items-center py-3">
        <div className="transition-colors duration-500 ease-in-out px-4 flex justify-center items-center py-3 bg-[#ffffff] dark:bg-[#0a0a0a] rounded-full shadow-1 z-index-1">
          <Link 
            href="/" 
