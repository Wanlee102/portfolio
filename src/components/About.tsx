        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
          <div className="md:col-span-2 space-y-6">
            <h3 className="text-2xl font-bold text-gray-800 border-l-4 border-indigo-600 pl-3">
              Chào, tôi là Lê Đức Minh Quân
            </h3>
            
            <p className="text-gray-700 leading-relaxed text-lg">
              Là một Full-stack Developer với kinh nghiệm 4 năm, tôi chuyên 
            ...
            <p className="text-gray-700 leading-relaxed text-lg">
              Lĩnh vực chuyên môn chính của tôi bao gồm: Next.js, Laravel, CodeIgniter và các thư viện 
          ...
          <div className="md:col-span-1 flex flex-col items-center md:items-start space-y-8">
            ...
            <div className="w-full">
                ...
                <ul className="space-y-3">
                    {['Next.js & React', 'Tailwind CSS', 'Node.js/Express', 'Database (SQL)', 'Laravel', 'CodeIgniter'].map((skill) => (
